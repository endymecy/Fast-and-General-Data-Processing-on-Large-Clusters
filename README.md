...
* [2 弹性分布式数据集](rdd/introduction.md)
...
* [3 建立在rdd上的模型](models-built-over-rdds/introduction.md)
...
* [4 离散化数据流](discretized-streams/introduction.md)
...
* [5 rdd通用性](generality-of-rdds/introduction.md)
...
* [6 总结](conclusion/lessons-learned.md)
